#define LOG_TAG "GnssHAL_GnssBatchingInterfaceExt2.0"
...
void GnssBatching::locationCb(int32_t locationsCount, FlpLocation** locations) {
     ...
     */
    std::vector<android::hardware::gnss::V2_0::GnssLocation> gnssLocations;
    for (int iLocation = 0; iLocation < locationsCount; iLocation++) {
        ...
        gnssLocations.push_back(convertToGnssLocation_2_0(locations[iLocation]));
    }
...
Return<bool> GnssBatching::init(const sp<::android::hardware::gnss::V1_0::IGnssBatchingCallback>& callback) {
return bool {};
}
...
Return<bool> GnssBatching::start(const ::android::hardware::gnss::V1_0::IGnssBatching::Options& options) {
    if (mFlpLocationIface == nullptr) {
        ALOGE("%s: Flp batching interface is unavailable", __func__);
        return false;
    }
...
Return<bool> GnssBatching::init_2_0(const sp<::android::hardware::gnss::V2_0::IGnssBatchingCallback>& callback) {
		if (mFlpLocationIface == nullptr) {
